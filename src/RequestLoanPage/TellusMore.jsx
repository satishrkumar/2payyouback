...
export default function TellusMore() {
    ...
    return (
            ...
            <div className="form-group ldInputRight">
                    <input type="text" name="dailyAmount" value={user.dailyAmount} onChange={handleChange} className={'form-control'} />
                </div></div>
            ...
            <div className="form-group ldInputRight">
                    <input type="text" name="monthlyAmount" value={user.monthlyAmount} onChange={handleChange} className={'form-control'} />
                </div></div>
            ...
            <div className="form-group ldInputRight">
                    <input type="text" name="quarterlyAmount" value={user.quarterlyAmount} onChange={handleChange} className={'form-control'} />
                </div></div>
            ...
            <div className="form-group ldInputRight">
                    <input type="text" name="annualyAmount" value={user.annualyAmount} onChange={handleChange} className={'form-control'} />
                </div></div>
