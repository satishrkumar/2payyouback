    ...
    <div className="container registerPage" style={containerBg}>
      <div className="row">
        ...
        <div className="col-md-5">
          ...
          <h2 className="mb-4 textAlignCenter bold">
            Add your profile details
          </h2>
          <h6 className="mt-3 mb-4 contentBold textAlignCenter bold">
          ...
          <form name="form" onSubmit={handleSubmit}>
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.birthday ? " is-invalid" : "")
                }
              />
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.phone ? " is-invalid" : "")
                }
              />
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.flatnumber ? " is-invalid" : "")
                }
              />
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.address1 ? " is-invalid" : "")
                }
              />
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.town ? " is-invalid" : "")
                }
              />
              {submitted && !user.town && (
            ...
            <div className="form-group">
              <input
                ...
                className={
                  "form-control registerPageInput" +
                  (submitted && !user.postalcode ? " is-invalid" : "")
                }
              />
            ...
            <div className="row w-100">
              <div className="col-md-6 marginTop">
                <h6 className="contentBold textAlignLeft">
                  Marketing Preferences
                </h6>
                <div className="form-group">
                  <span className="registerSpacebetween fontSize">
                    {" "}
                    <input
                      type="checkbox"
                      name="emailid"
              ...
              <div className="col-md-6 marginTop">
                ...
                <div className="form-group">
                  <span className="registerSpacebetween fontSize">
                    ...
                    <input
                      type="checkbox"
                      name="constactEmailid"
                      value={user.constactEmailid}
                      onClick={handleChange}
                    />{" "}
                    Email Id
                  </span>
            ...
            <div className="bottomBox">
              ...
              <div className="rightB">Activate one touch</div>
            </div>
            <div className="bottomBox">
              <div className="leftB">
                <input
              ...
              <div className="rightB">
                I agree to receive marketing communications from 2PayUBack.
                <br />I can change my notification preferences at any time.
              </div>
            </div>
            <div className="bottomBox">
              <div className="leftB">
              ...
              <div className="rightB">
                By clicking the button below, I agree to be bound by 2PayUBack's{" "}
                <br />{" "}
                <Link class="activeLink">
                  {" "}
                  <u>User Agreement</u>
                </Link>{" "}
                and{" "}
